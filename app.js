...
if (game.party[0].name === "Charmander") {
    game.party.splice(0, 1, pokemon[5]);
}

if (game.party[0].name === "Squirtle") {
    game.party.splice(0, 1, pokemon[8]);
}

if (game.party[0].name === "Pikachu") {
    game.party.splice(0, 1, pokemon[26]);
}
...
const starterPok = pokemon[0, 3, 6, 24];

for (let i = 0; i < starterPok.length; i++) {
    console.log(starterPok[i].name);
}
...
console.log(partyCount());//fooor mee
